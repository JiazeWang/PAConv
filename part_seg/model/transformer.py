...
if __name__ == "__main__":
    global_chunk = GlobalTransformer(npoint = 2048, radius=0.2, nsample=16, dim_feature=64, dim_hid=64, nhead=4, num_layers=2, norm_cfg=dict(type='BN2d'), enc_ratio=1, local_drop=0.0, prenorm=True)
    print(global_chunk)
    #num_points=(2048, 1024, 512, 256),
    #radius=(0.2, 0.4, 0.8, 1.2),
    #num_samples=(16, 16, 16, 16),
