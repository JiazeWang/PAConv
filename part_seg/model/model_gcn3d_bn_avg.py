...
class GCN3D(nn.Module):
    def __init__(self, class_num, support_num, neighbor_num):
        ...
        self.conv_0 = gcn3d.Conv_surface_avg(kernel_num= 128, support_num= support_num)
        self.conv_1 = gcn3d.Conv_layer_avg(128, 128, support_num= support_num)
        self.pool_1 = gcn3d.Pool_layer(pooling_rate= 4, neighbor_num= 4)
        self.conv_2 = gcn3d.Conv_layer_avg(128, 256, support_num= support_num)
        self.conv_3 = gcn3d.Conv_layer_avg(256, 256, support_num= support_num)
        self.pool_2 = gcn3d.Pool_layer(pooling_rate= 4, neighbor_num= 4)
        self.conv_4 = gcn3d.Conv_layer_avg(256, 512, support_num= support_num)
